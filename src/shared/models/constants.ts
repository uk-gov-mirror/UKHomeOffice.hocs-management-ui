...
export const ARCHIVE_CASE_NOT_FOUND_ERROR_DESCRIPTION = 'Case not found, unable to archive. Please check case reference.';
export const ARCHIVE_CASE_FORBIDDEN_ERROR_DESCRIPTION = 'Access is denied, unable to archive. Please check case is accessible to your team.';
export const ARCHIVE_CASE_ERROR_DESCRIPTION = 'Something went wrong while archiving a case. Please try again.';
export const ARCHIVE_CASE_SUCCESS = 'The case was archived successfully';
export const UNARCHIVE_CASE_NOT_FOUND_ERROR_DESCRIPTION = 'Case not found, unable to unarchive. Please check case reference.';
export const UNARCHIVE_CASE_FORBIDDEN_ERROR_DESCRIPTION = 'Access is denied, unable to unarchive. Please check case is accessible to your team.';
export const UNARCHIVE_CASE_ERROR_DESCRIPTION = 'Something went wrong while unarchiving a case. Please try again.';
export const UNARCHIVE_CASE_SUCCESS = 'The case was unarchived successfully';
...
export const AMEND_BUS_UNIT_ERROR_DESCRIPTION = 'Something went wrong while amending the business unit. Please contact the service desk.';
export const ADD_ENQ_REASON_ERROR_DESCRIPTION = 'Something went wrong while adding the enquiry reason. Please contact the service desk.';
...
export const AMEND_ENQ_REASON_ERROR_DESCRIPTION = 'Something went wrong while amending the enquiry reason. Please contact the service desk.';
