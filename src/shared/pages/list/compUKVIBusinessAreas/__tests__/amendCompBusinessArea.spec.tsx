...
const renderComponent = () => render(
    <MemoryRouter>
        <AmendCompBusinessArea history={history} location={location} match={match}></AmendCompBusinessArea>
    </MemoryRouter>
);
...
describe('when the submit button is clicked', () => {
    ...
    describe('and the data is not filled in', () => {
        ...
        it('should set the error state', () => {
            expect(addFormErrorSpy).toHaveBeenNthCalledWith(1, { key: 'title', value: 'The New Business Unit name is required' });
        });
    });
});
