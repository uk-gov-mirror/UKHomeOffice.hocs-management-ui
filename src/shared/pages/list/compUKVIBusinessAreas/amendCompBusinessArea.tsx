...
interface AmendCompBusAreaProps extends RouteComponentProps<MatchParams> {
    csrfToken?: string;
}
...
const AmendCompBusinessArea: React.FC<AmendCompBusAreaProps> = ({ csrfToken, history, match }) => {
...
export default AmendCompBusinessArea;
