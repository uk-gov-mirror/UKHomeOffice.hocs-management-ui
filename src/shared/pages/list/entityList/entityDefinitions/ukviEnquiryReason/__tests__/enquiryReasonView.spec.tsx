...
const EnquiryReason = EntityListView(enquiryReason);
...
const renderComponent = () => render(
    <MemoryRouter>
        <EnquiryReason history={history} location={location} match={match}></EnquiryReason>
    </MemoryRouter>
);
...
describe('when the ukviEnquiryReason EntityListView component is mounted', () => {
