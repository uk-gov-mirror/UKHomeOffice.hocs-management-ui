...
import trofCampaign from '../trofCampaign';
...
const CampaignsView = EntityListView(trofCampaign);
...
describe('when the trofCampaign EntityListView component is mounted', () => {
