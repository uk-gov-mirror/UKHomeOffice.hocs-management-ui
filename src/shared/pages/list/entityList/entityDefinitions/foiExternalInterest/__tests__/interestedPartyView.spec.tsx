...
const FoiInterestedPartyView = EntityListView(foiInterestedParty);
...
const renderComponent = () => render(
    <MemoryRouter>
        <FoiInterestedPartyView history={history} location={location} match={match}></FoiInterestedPartyView>
    </MemoryRouter>
);
...
describe('when the foiInterestedParty EntityListView component is mounted', () => {
