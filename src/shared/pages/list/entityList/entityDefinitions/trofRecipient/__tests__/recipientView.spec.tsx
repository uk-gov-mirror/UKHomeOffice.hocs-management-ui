...
const RecipientsView = EntityListView(trofRecipient);
...
const renderComponent = () => render(
    <MemoryRouter>
        <RecipientsView history={history} location={location} match={match}></RecipientsView>
    </MemoryRouter>
);
...
describe('when the trofRecipient EntityListView component is mounted', () => {
