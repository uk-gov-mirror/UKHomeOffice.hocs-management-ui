...
describe('Document add component', () => {
    ...
    it('should render disabled when passed', () => {
        const wrapper = mount(<DocumentAdd name={FIELD_NAME} updateState={() => null} disabled />);
        expect(wrapper).toBeDefined();
    ...
    it('should allow multiple files when passed', () => {
        const wrapper = mount(<DocumentAdd name={FIELD_NAME} updateState={() => null} allowMultiple />);
        expect(wrapper).toBeDefined();
